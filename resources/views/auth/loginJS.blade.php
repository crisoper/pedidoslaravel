<script>
    ...
    if ( $("#login").hasClass('active') ) {
        $(".li_login").attr('style','border-bottom:3px solid #0056C3 !important; ');
    }
   
    if ( $("#register").hasClass('active') ) {
        $(".li_register").attr('style','border-bottom:3px solid #0056C3 !important; color: #0056C3 !important;');
    }
   
    $(".li_login").on('click', function(){
        $(".li_login").attr('style','border-bottom:3px solid #0056C3 !important; color: #0056C3 !important; font: bold !important;')
        $(".li_register").removeAttr('style');
    });
    
    $(".li_register").on('click', function(){
        $(".li_register").attr('style','border-bottom:3px solid #0056C3 !important; color: #0056C3 !important; font: bold !important;');
