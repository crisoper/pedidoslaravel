    ...
    <link rel="stylesheet" href="{{asset('pedidos/css/elegant-icons.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('pedidos/css/nice-select.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('pedidos/css/jquery-ui.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('pedidos/css/owl.carousel.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('pedidos/css/slicknav.min.css')}}" type="text/css">
