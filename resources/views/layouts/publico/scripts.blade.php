    ...
    {{-- MENUS --}}
    <script src="{{asset('pedidos/menus/js/menumovil.js')}}"></script>
    <script src="{{asset('pedidos/menus/js/menu2.js')}}"></script>

    {{-- CARRITO COMPRAS --}}
    <script src="{{asset('pedidos/carritocompras/js/carritocomprasmenu.js')}}"></script>
    <script src="{{asset('pedidos/carritocompras/js/favoritosmenu.js')}}"></script>
