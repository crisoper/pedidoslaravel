@extends('layouts.publico.comprador')
                ...
                <div class="col-3 menu">
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home"
                            role="tab" aria-controls="v-pills-home" aria-selected="true">Mi cuenta</a>
                        <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile"
                            role="tab" aria-controls="v-pills-profile" aria-selected="false">Editar información</a>
                        <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages"
                            role="tab" aria-controls="v-pills-messages" aria-selected="false">Cambiar contraseña</a>
                            ...
                            <form action="" method="POST">
                                <div class="form-row pb-4">
                                    <div class="col text-center">
                                        <img width="100px" height="100px" @if ( auth()->user()->avatar != null &&
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-xs-12 col-sm-6">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                @foreach (auth()->user()->roles()->where('guard_name', '=',
                                                'web')->pluck('name') as $rol )
                                                {{ $rol }}
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-xs-12 col-sm-12">
                                        <a class="text-danger pl-0" href="{{ route('logout') }}"
