                            ...
                            <div class="col-7 mx-auto">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="ruc" id="ruc" maxlength="11" class="form-control" value="{{ $empresa->ruc }}">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" name="paginaweb" id="paginaweb" class="form-control" value="{{ $empresa->paginaweb }}">
                                ...
                                <div class="form-row"> 
                                    <div class="form-group col-12">
                                        <div class="cajaInputAgregarLogo text-center">
                                            <label for="logo">
                                                <div class="cajaNombreLogo" data-text="">Seleccionar Nuevo Logo</div>
                                            </label>
