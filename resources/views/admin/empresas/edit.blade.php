                    ...
                    <div class="col-12  mx-auto ">
                        <div class="card card-outline card-primary">
                            <div class="card-header">
                                <span>Editar los datos de tu empresa</span>
                            </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 d-flex flex-wrap">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <input type="text" name="ruc" id="ruc" size="11" maxlength="11"
                                                class="form-control " value="{{$empresa->ruc}}"
                                                placeholder="Ruc">
                                        ...
                                        <div class="form-group col-md-6 col-sm-12">
                                            ...
                                            <input type="text" name="nombre" id="nombre"
                                                class="form-control" value="{{$empresa->nombre}}"
                                        ...
                                        <div class="form-group col-md-12 col-sm-12">
                                            ...
                                            <input type="text" name="direccion" id="direccion"
                                                class="form-control" value="{{ $empresa->direccion }}"
