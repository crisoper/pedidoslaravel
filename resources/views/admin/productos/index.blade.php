                                ...
                                <tbody id="tablaProductos">
                                    @foreach ($productos as $producto)
                                        <tr id="{{$producto->id}}">
                                            ...
                                            <td class="text-center">
                                                <a class="" href="{{route('productos.edit', $producto->id)}}" title="Editar">
                                            ...
                                            <td class="text-center">
                                                <form id="form.producto.delete.{{$producto->id}}" action="{{ route('productos.destroy', $producto->id) }}" method="POST">
                                                    {!! method_field('DELETE') !!}
                                                    {!! csrf_field() !!}
                                                    <a class="text-danger" href="#" onclick="event.preventDefault(); document.getElementById('form.producto.delete.{{$producto->id}}').submit();" title="Eliminar">
