...
<div class="container-fluid">
    <div class="row menuconfig">
        <div class="col-12 col-md-6 col-lg-3 border-right border-danger">
                    ...
                    <div class="form-row">
                        <div class="form-group col-12">
                            <div class="cajaInputAgregarLogo text-center">
                                <img src="{{ asset( Storage::disk('usuarios')->url('empresaslogos/').$empresa->logo ) }}" width="250px" height="200px" alt="Logo de empresa" alt="{{$empresa->logo}}">
                            </div>
                        </div>
                    </div>
                </div>
